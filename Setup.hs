...
--
getLdVersion :: FilePath -> IO [Int]
getLdVersion ldPath = do
...
--
validateLinker :: Platform -> ProgramDb -> IO ()
validateLinker (Platform X86_64 Windows) db = do
  putStrLn "Hello!"
    ...
    postConfHook args flags pkg_descr lbi
      = let verbosity = fromFlag (configVerbosity flags)
        ...
        in do
          ...
          validateLinker currentPlatform $ configPrograms  flags
